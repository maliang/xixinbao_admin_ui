...
declare global {
  ...
  const ImageUpload: typeof import('./../components/common/ImageUpload.vue')['default']
  ...
  const RichTextEditor: typeof import('./../components/common/RichTextEditor.vue')['default']
